...
namespace Iksap.ItsmReporting.Web
{
    public static class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //dataTables Bundles
            bundles.Add(
                new ScriptBundle("~/Bundles/dataTablesjs")
                    .Include(
                        "~/lib/jquery-datatable/jquery.dataTables.js",
                        "~/lib/jquery-datatable/skin/bootstrap/js/dataTables.bootstrap.js",
                        "~/lib/jquery-datatable/extensions/export/dataTables.buttons.min.js",
                        "~/lib/jquery-datatable/extensions/export/buttons.flash.min.js",
                        "~/lib/jquery-datatable/extensions/export/jszip.min.js",
                        "~/lib/jquery-datatable/extensions/export/pdfmake.min.js",
                        "~/lib/jquery-datatable/extensions/export/vfs_fonts.js",
                        "~/lib/jquery-datatable/extensions/export/buttons.html5.min.js",
