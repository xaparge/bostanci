...
﻿using Abp.Owin;
using Iksap.ItsmReporting.Api.Controllers;
using Iksap.ItsmReporting.Web;
...
namespace Iksap.ItsmReporting.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in ItsmReportingWebModule)
